 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "\n",
    "purchase_c = unique_df[\"Gender\"].value_counts()\n",
    "\n",
    "#Average Purchase Price\n",
    ...
    "\n",
    "#Create new dataframe\n",
    "gender_analysis = pd.DataFrame({\"Purchase Count\": [male_purchases,female_purchases,other_purchases], \"Average Purchase Price\": average_price,\"Total Purchase Price\":purchase_price,\"Normalized Totals\": normalized})\n",
    "\n",
    ...
    "#Reorder Columns\n",
    "gender_analysis = gender_analysis[[\"Purchase Count\",\"Average Purchase Price\", \"Total Purchase Price\", \"Normalized Totals\"]]\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "pymoli_groupby_sn_agegrp = purchase_data.groupby([\"SN\",\"Age Ranges\"])\n",
    "\n",
    "                                                              \n",
    "pymoli_unique_payers_df = pd.DataFrame(pymoli_groupby_sn_agegrp.size())\n",
    "#print(pymoli_unique_payers_df)\n",
    "pymoli_agegrp_df = pd.DataFrame(pymoli_unique_payers_df.groupby([\"Age Ranges\"]).count())\n",
  ...
  },
  {
   ...
   "source": [
    "pymoli_agegrp_not_sn_df = pd.DataFrame(purchase_data.groupby([\"Age Ranges\"]).count())\n",
    "pymoli_agegrp_sum_not_sn_df = pd.DataFrame(purchase_data.groupby([\"Age Ranges\"]).sum())\n",
    ...
    "\n",
    "pymoli_agegrp_df[\"Avg Total Purchase per Person\"] =  round(pymoli_agegrp_df[\"Total Purchase Value\"]/pymoli_agegrp_df[\"Total Count\"],2).map(\"${:,.2f}\".format)\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "#Reorder Columns\n",
    "sorted_df = sorted_df[[\"Purchase Count\", \"Average Purchase Price\", \"Total Purchase Value\"]]\n",
    "\n",
    "#Display top 5\n",
    "sorted_df.head(5)"
   ]
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "sorted_items[\"Item Price\"] = sorted_items[\"Item Price\"].map(\"${:,.2f}\".format) \n",
    "sorted_items[\"Total Purchase Value\"] = sorted_items[\"Total Purchase Value\"].map(\"${:,.2f}\".format) \n",
    "\n",
    "#Reorder Columns\n",
    "sorted_items = sorted_items[[\"Purchase Count\", \"Item Price\", \"Total Purchase Value\"]]\n",
    "\n",
    "\n",
    "#Display top 5\n",
    "sorted_items.head(5)"
